...
void main() {
  ...
  group('Given an interval of 10 and a start offset of 5', () {
    final adsCalculator =
        AdsCalculator(adInterval: 10, adStart: 5, ignoreAds: false);
  ...
  group('Given a premium user (no ads)', () {
    final adsCalculator =
        AdsCalculator(adInterval: 10, adStart: 5, ignoreAds: true);
    group('isAd works correctly', () {
      final tests = [
        _IsAdTestCase(position: 0, fullSize: 20, resIsAd: false),
        _IsAdTestCase(position: 1, fullSize: 20, resIsAd: false),
        ...
        _IsAdTestCase(position: 3, fullSize: 20, resIsAd: false),
        _IsAdTestCase(position: 4, fullSize: 20, resIsAd: false),
        _IsAdTestCase(position: 5, fullSize: 20, resIsAd: false),
        _IsAdTestCase(position: 6, fullSize: 20, resIsAd: false),
        _IsAdTestCase(position: 7, fullSize: 20, resIsAd: false),
        _IsAdTestCase(position: 8, fullSize: 20, resIsAd: false),
        _IsAdTestCase(position: 9, fullSize: 20, resIsAd: false),
        ...
        _IsAdTestCase(position: 13, fullSize: 20, resIsAd: false),
        _IsAdTestCase(position: 14, fullSize: 20, resIsAd: false),
        _IsAdTestCase(position: 15, fullSize: 20, resIsAd: false),
        _IsAdTestCase(position: 16, fullSize: 20, resIsAd: false),
        _IsAdTestCase(position: 17, fullSize: 20, resIsAd: false),
        _IsAdTestCase(position: 18, fullSize: 20, resIsAd: false),
        _IsAdTestCase(position: 19, fullSize: 20, resIsAd: false),
        _IsAdTestCase(position: 20, fullSize: 20, resIsAd: false),
        _IsAdTestCase(position: 15, fullSize: 17, resIsAd: false),
        _IsAdTestCase(position: 5, fullSize: 7, resIsAd: false),
        _IsAdTestCase(position: 5, fullSize: 8, resIsAd: false),
        _IsAdTestCase(position: 0, fullSize: 1, resIsAd: false),
      ];
      for (final testCase in tests) {
        test(
            'When the position is ${testCase.position} and the full size is ${testCase.fullSize}, then the result is ${testCase.resIsAd}',
            () {
          expect(
              adsCalculator.isAd(
                  index: testCase.position, fullSize: testCase.fullSize),
    ...
    group('getItemIndex works correctly', () {
      final tests = [
        ...
        _GetItemIndexTestCase(position: 3, fullSize: 20, resIndexItem: 3),
        _GetItemIndexTestCase(position: 4, fullSize: 17, resIndexItem: 4),
        _GetItemIndexTestCase(position: 5, fullSize: 17, resIndexItem: 5),
        _GetItemIndexTestCase(position: 6, fullSize: 17, resIndexItem: 6),
        _GetItemIndexTestCase(position: 7, fullSize: 17, resIndexItem: 7),
        _GetItemIndexTestCase(position: 8, fullSize: 17, resIndexItem: 8),
        _GetItemIndexTestCase(position: 9, fullSize: 17, resIndexItem: 9),
        _GetItemIndexTestCase(position: 10, fullSize: 17, resIndexItem: 10),
        _GetItemIndexTestCase(position: 11, fullSize: 17, resIndexItem: 11),
        _GetItemIndexTestCase(position: 12, fullSize: 17, resIndexItem: 12),
        _GetItemIndexTestCase(position: 13, fullSize: 17, resIndexItem: 13),
        _GetItemIndexTestCase(position: 14, fullSize: 17, resIndexItem: 14),
        _GetItemIndexTestCase(position: 15, fullSize: 17, resIndexItem: 15),
        _GetItemIndexTestCase(position: 16, fullSize: 17, resIndexItem: 16),
        _GetItemIndexTestCase(position: 17, fullSize: 19, resIndexItem: 17),
        _GetItemIndexTestCase(position: 26, fullSize: 27, resIndexItem: 26),
        _GetItemIndexTestCase(position: 27, fullSize: 28, resIndexItem: 27),
      ];
      for (final testCase in tests) {
        test(
            'When the position is ${testCase.position} and the full size is ${testCase.fullSize}, then the result is ${testCase.resIndexItem}',
            () {
          expect(
              adsCalculator.getItemIndex(
                  position: testCase.position, fullSize: testCase.fullSize),
    ...
    group('getFullListSize works correctly', () {
      for (int i = 0; i < 40; i++) {
        test('When the size is $i, then the result is $i', () {
          expect(adsCalculator.getFullListSize(itemsSize: i), equals(i));
        });
      }
    });
  });
